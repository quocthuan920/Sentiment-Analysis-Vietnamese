...
y_train = df_train.Constructiveness
y_test = df_test.Constructiveness
...
grid_predictions = svc.predict(X_test_vect) 
...
filename = 'models/svm_model_ViCTSD_Constructiveness.sav'
...
input_test['Constructiveness'] = y_predict
# test_data['content'] = test_list
input_test = df_test.sort_values(by=['Constructiveness'])
input_test[['Comment', 'Constructiveness']].to_csv('submits/svm_ViCTSD_Constructiveness.csv',encoding="utf-8-sig", index=False)
