...
filename = 'models/BAYES_model_ViCTSD_Constructiveness.sav'
...
input_test[['Comment', 'Constructiveness']].to_csv('submits/BAYES_ViCTSD_Constructiveness.csv',encoding="utf-8-sig", index=False)
