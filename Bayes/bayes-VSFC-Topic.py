...
report1 = metrics.classification_report(y_test, ynb_pred, labels=['0', '1', '2', '3'], digits=3, zero_division=0)
...
filename = 'models/BAYES_model_VSFC_Topics.sav'
...
input_test[['Sents', 'Topics']].to_csv('submits/BAYES_VSFC_Topics.csv',encoding="utf-8-sig", index=False)
